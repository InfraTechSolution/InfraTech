        ...
        <>
            ...
            <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-slate-900">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                    ...
                    >
                        <motion.div variants={fadeIn} className="inline-block mb-4 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 font-medium text-sm">
                            Innovating Future Technology
                        </motion.div>
                        <motion.h1 variants={fadeIn} className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 mb-6 tracking-tight leading-tight">
                            Building Scalable <br />
                            <span className="text-blue-500">Digital Solutions</span> <br />
                            for Global Enterprises
                        </motion.h1>
                        <motion.p variants={fadeIn} className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        ...
                        <Card key={index} className="group hover:border-blue-500/50 transition-colors">
                            ...
                            <Link to="/services" className="text-blue-600 dark:text-blue-400 font-medium flex items-center hover:translate-x-1 transition-transform">
            ...
            <section className="py-20 bg-blue-600 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    ...
                    <Button to="/contact" className="bg-white text-blue-600 hover:bg-blue-50">
                        Start Your Journey
                    </Button>
                </div>
            </section>
